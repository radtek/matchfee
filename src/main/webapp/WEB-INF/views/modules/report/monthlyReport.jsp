		...
		$(document).ready(function() {		
			...
			$("#btnExport").click(function(){
				top.$.jBox.confirm("确认要导出数据吗？","系统提示",function(v,h,f){
					if(v=="ok"){
						$("#searchForm").attr("action","${ctx}/report/report/monthlyReportExport");
						$("#searchForm").submit();
					}
				},{buttonsFocus:1});
			...
			$("#btnSubmit").click(function(){
				$("#searchForm").attr("action","${ctx}/report/report/monthlyReport");
				$("#searchForm").submit();
			});
...
<body>
	<legend>征收月报</legend>
	<form:form id="searchForm" modelAttribute="reportParam" action="${ctx}/report/report/monthlyReport" method="post" class="breadcrumb form-search">
		<ul class="ul-form">	
			<li>		
			    <label>缴费月份 ：</label>
